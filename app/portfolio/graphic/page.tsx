...
const SECTIONS = [
  {
    ...
    items: [
      { src: '/image/graphic/post-1.webp', alt: 'Our Services Post',   label: 'Our Services Post'   },
      { src: '/image/graphic/post-2.webp', alt: 'GAIA Brand Post',     label: 'GAIA Brand Post'     },
      { src: '/image/graphic/post-3.webp', alt: 'Booked to Speak',     label: 'Booked to Speak'     },
      { src: '/image/graphic/post-4.webp', alt: 'Buccaneers Games',    label: 'Buccaneers Games'    },
      { src: '/image/graphic/post-5.webp', alt: 'Open House Listing',  label: 'Open House Listing'  },
      { src: '/image/graphic/post-6.webp', alt: 'Fashion Editorial',   label: 'Fashion Editorial'   },
      { src: '/image/graphic/post-7.webp', alt: 'Skincare Campaign',   label: 'Skincare Campaign'   },
