      ...
      <section className="vision-section" aria-label="The person behind the lens">
        <div className="vision-container">
          ...
          <div className="vision-content">
            ...
            <p>My work gave me the opportunity to shoot personal content for artists like Badshah,Prince Narula and, while also covering large-scale concerts featuring Paradox, Parmish Verma and Maahi. I also led coverage for major events including Riwayat, Apratim, Fur Fest, cyclothons, pet events, and brand activations including a Domino&apos;s event.</p>
